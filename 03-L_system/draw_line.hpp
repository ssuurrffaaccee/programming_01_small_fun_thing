...
void draw_axis(){
  PPMDumper::outputSegments().push_back(make_segment(make_vec(0.0f,0.5f),make_vec(1.0f,0.5f)));
  PPMDumper::outputSegments().push_back(make_segment(make_vec(0.5f,0.0f),make_vec(0.5f,1.0f)));
}